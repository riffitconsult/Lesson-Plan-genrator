...
# ==========================================
st.set_page_config(
    page_title="PlanAhead: NaCCA AI Lesson Wizard",
    page_icon="🤖",
    layout="wide",
...
# ==========================================
# 4. MASTER CURRICULUM DATA (NaCCA Structured)
# ==========================================
CURRICULUM_DATA = {
    ...
    "Common Core Programme (CCP) (Basic 7 - 9 / JHS 1 - 3)": {
        "French Language (CCP)": {
            ...
            "Compréhension Écrite": [
                "Lecture et analyse de textes courts",
...
if not st.session_state["authenticated"]:
    ...
    with col_l2:
        teacher_name = st.text_input(
            "👤 Teacher Name", placeholder="e.g., Mme. Dupont / Mr. Mensah"
        )
...
<div class="top-navbar">
    <div class="brand-title">📘 PlanAhead: NaCCA AI Lesson Wizard</div>
...
if nav_choice == "📝 Lesson Plan Generator":
    ...
    st.markdown("### Step 1: Lesson & NaCCA Framework Details")
    ...
    with col_1:
        plan_language = st.selectbox(
            ...
            [
                "English 🇬🇧",
                "Français 🇫🇷 (French)",
                "English with French Terminology",
            ],
        )
    ...
    with col_2:
        ...
        content_standard = st.text_input(
            "Content Standard (e.g., B8.1.1.1)",
            value="Demonstrate understanding of conversational exchanges.",
        )

        indicator_input = st.text_input(
            "Indicator / Exemplars (e.g., B8.1.1.1.1)",
            value="B8.1.1.1.1: Use appropriate greetings and polite expressions.",
        )

        topic_input = st.text_input(
            "Topic / Sub-topic", value="Se présenter et saluer / Greetings"
        )
    ...
    st.markdown("### 🏡 Context & Core Competencies")
    col_c1, col_c2 = st.columns(2)
    with col_c1:
        core_competencies = st.multiselect(
            "Core Competencies (NaCCA)",
            [
    ...
    if st.button("🚀 Generate Draft"):
        if not selected_days:
            ...
            with st.spinner("Generating customized NaCCA lesson plan in table format..."):
                try:
